...
export default function Swap({ currencies }) {
  ...
  const [coin1DialogOpen, setCoin1DialogOpen] = useState(true)
      ...
      <div style={{ background: currencies[coin1].color, flex: 1 }}>
        ...
        >
          ...
          >
            <Typography
              variant="h5"
              sx={{ mr: 2, fontWeight: "bold", minWidth: 100 }}
            >
              FROM
            </Typography>
            <Box
            ...
            >
              <Coin>{currencies[coin1].short_name}</Coin>
            ...
            <TextField
              ...
              placeholder="0.00"
            />
            <Box sx={{ flex: 4, display: "flex", gap: 2, minWidth: 320 }}>
        ...
        <Container maxWidth="xl" sx={{ height: "100%" }}>
          ...
          >
            ...
            <Box
              ...
              onClick={() => setCoin1DialogOpen(true)}
            >
              <Coin>{currencies[coin2].short_name}</Coin>
              <Typography variant="h6" sx={{ fontWeight: "bold" }}>
            ...
            <TextField
              ...
              placeholder="0.00"
            />
            <Box sx={{ flex: 4, display: "flex", gap: 2, minWidth: 315 }}>
              <Typography sx={{ ml: "auto" }}>
                <strong>Current Balance:</strong>
              </Typography>
              <Box sx={{ position: "relative" }}>
