      ...
      <Paper sx={{ display: "flex", flexDirection: "column" }}>
        <Box sx={{ padding: 2, display: 'flex' }}>
          <Link href='/liquidity' passHref>
            <IconButton sx={{ borderRadius: 2, mr: 2, py: 1, px: 0, mb: 'auto' }}>
          ...
          <Box>
            ...
            <Typography variant="body2">
              Select which a token pair to add liquidity to that pool. After adding, you will recieve a proof of liquidity token in return.
            </Typography>
          </Box>
        </Box>
        <Divider/>
        ...
        <AddCircleIcon fontSize="large" sx={theme => ({ color: theme.palette.primary.main, margin: 'auto' })}/>
        <Box sx={{ padding: 2, display: 'flex', flexFlow: 'row wrap', gap: 1 }}>
