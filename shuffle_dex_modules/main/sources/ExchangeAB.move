module Sender::ExchangeAB {
	...
	public fun mint(amount: u64, account: &signer): u64 acquires LPCoinAB {
		...
		CoinEvents::emit_mint_event<LPCoinAB>(b"LPCoin AB", amount, account_addr);
		amount
	}
	...
	fun burn(account: address, amt:u64) acquires LPCoinAB {
		...
		CoinEvents::emit_burn_event<LPCoinAB>(b"LPCoin AB", amt, account);
	}
	...
	public fun transfer_between(from_addr: address, to_addr: address, transfer_amt: u64): u64 acquires LPCoinAB {
		...
		CoinEvents::emit_transfer_event<LPCoinAB>(b"LPCoin AB", transfer_amt, from_addr, to_addr);
	...
	public fun initialize(exchange_acct: &signer, comm_rate: u64, coin_a_amt: u64, coin_b_amt: u64) acquires LPCoinAB, ExchangeAB {
	...
	public(script) fun initialize_exchange(exchange: signer, comm_rate: u64, coin_a_amt: u64, coin_b_amt: u64) acquires LPCoinAB, ExchangeAB {
